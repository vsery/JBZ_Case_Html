$(function() {
	//$(".js-add-region .app-add-field").append('<ul><li><a class="js-new-field" data-field-type="richtext">富文本</a></li> <li><a class="js-new-field" data-field-type="goods">商品</a></li> <li><a class="js-new-field" data-field-type="goodslist">商品<br>列表 </a></li> <li><a class="js-new-field" data-field-type="imagead">图片<br>广告 </a></li> <li><a class="js-new-field" data-field-type="cube2">魔方</a></li> <li><a class="js-new-field" data-field-type="title">标题</a></li> <li><a class="js-new-field" data-field-type="textnav">文本<br>导航 </a></li> <li><a class="js-new-field" data-field-type="nav">图片<br>导航 </a></li> <li><a class="js-new-field" data-field-type="link">关联<br>链接 </a></li> <li><a class="js-new-field" data-field-type="search">商品<br>搜索 </a></li> <li><a class="js-new-field" data-field-type="showcase">橱窗</a></li> <li><a class="js-new-field" data-field-type="line">辅助线</a></li> <li><a class="js-new-field" data-field-type="space">辅助<br>空白 </a></li> <li><a class="js-new-field" data-field-type="component">自定义<br>模块 </a></li> <li><a class="js-new-field" data-field-type="store">进入<br>店铺 </a></li> <li><a class="js-new-field" data-field-type="tag_list">商品<br>分组1 </a></li> <li><a class="js-new-field" data-field-type="tags">商品<br>分组2 </a></li> <li><a class="js-new-field" data-field-type="audio">语音</a></li> <li><a class="js-new-field" data-field-type="notice">公告</a></li> <li><a class="js-new-field" data-field-type="coupon">优惠券</a></li> </ul>');
	$(".js-add-region .app-add-field").append('<ul><li><a class="js-new-field" data-field-type="richtext">富文本</a></li></ul>');
	...
	$("body").on("click", ".app-field", function() {
		...
		$(".app-sidebar").css("marginTop", ($(this).offset().top - 186));
	});
});
var PowerPage = {
	Set : {
		Pichost : "",/* 图片域名 */
		HasUedit : false,/* 富文本编辑器是否实例化过 */
		ShopMess:{
			id:0,
			shopname:"美味阁",
			shoplogo:"/source/images/logo.png"
		},
	},
	Dom : {
		Preview : $(".app-preview"),
	...
	EditTemp : { /* 实例模板 */
		defaultval : {
			imageadpic : [ {
				name : "",
				pic : "/source/images/image_ad.jpg",
				url : "",
				urldesc : "设置链接到的页面地址",
			} ],
			goods : [ {
	...
	Format : {
		...
		FormatBox : function(obj) {
			...
			//action.html('<div class="actions-wrap"><span class="action edit">编辑</span><span class="action add">加内容</span>'+(obj.candelete==null?'<span class="action delete">删除</span>':'')+'</div>');
	...
	Modify : {
		...
		ModifyMainTop : function(obj) {
			...
			box.append(group);
			group = $('<div class="control-group"> <label class="control-label">店铺Logo：</label> <div class="controls"> <img src="https://img.yzcdn.cn/upload_files/2015/05/19/Fid8phqI19UpN6FKiKjfdBUKongT.png?imageView2/2/w/145/h/145/q/75/format/webp" width="80" height="80" class="thumb-image" style="width: 80px; height: 80px;"> <a class="control-action js-trigger-avatar" href="javascript: void(0);">修改店铺Logo</a> </div> </div>');
			box.append(group);
			PowerPage.Dom.SidBar.html(box);
		...
		ModifyPageTitle : function(obj) {
			var box = $('<div class="form-horizontal"></div>');
			var group = $('<div class="control-group">				<label class="control-label"><em class="required">*</em>页面名称：</label>				<div class="controls">					<input class="input-xxlarge" type="text" name="title" value="微页面标题">				</div>			</div>');
			box.append(group);
			group = $('<div class="control-group">				<label class="control-label">页面描述：</label>				<div class="controls">					<input class="input-xxlarge" type="text" name="description" value="" placeholder="用户通过微信分享给朋友时，会自动显示页面描述">				</div>			</div>');
			box.append(group);
			group = $('<div class="control-group">				<label class="control-label">分类：</label>				<div class="controls">					<select class="js-category chosen-select" name="category" data-selected-id="" multiple="" data-placeholder="选择微页面分类" style="display: none;"><option value="6322440">最热分类</option>						<option value="6322439">最新分类</option>						<option value="6322438">未分类</option></select>					<div class="chosen-container chosen-container-multi" style="width: 220px;" title="">						<ul class="chosen-choices">							<li class="search-field"><input type="text" value="选择微页面分类" class="default" autocomplete="off" style="width: 116px;"></li>						</ul>						<div class="chosen-drop">							<ul class="chosen-results"></ul>						</div>					</div>					<p class="help-inline">						<a class="js-refresh-category" href="javascript:void(0);">刷新</a>						<span>|</span> <a class="new_window" target="_blank" href="//koudaitong.com/v2/showcase/category#create">+新建</a>					</p>				</div>			</div>');
			box.append(group);
			group = $('<div class="control-group">				<label class="control-label">背景颜色：</label>				<div class="controls">					<input type="color" value="'+obj.background+'" name="color">					<button class="btn js-reset-bg" type="button">重置</button>					<p class="help-desc">背景颜色只在手机端显示。</p>				</div>			</div>');
			box.append(group);
			PowerPage.Dom.SidBar.html(box);
		...
		ModifyRich : function(obj) {
			...
			bg.html('<div class="pull-left">		            <label class="control-label">背景颜色：</label>		            <div class="input-append">		                <input type="color" value="' + obj.background + '" name="color" class="span1">		                <button class="btn js-reset-bg" type="button">重置</button>		            </div>		        </div><div class="pull-left">		            <label class="control-label">是否全屏：</label>		            <label class="checkbox inline">		                <input type="checkbox" name="fullscreen" ' + (obj.fullscreen ? 'checked=""' : '') + '> 全屏显示		            </label>		        </div>');
			box.append(bg);
			...
			baidu.editor.commands['myimage'] = { execCommand: function() { selectpic(function(result){
				for(var i=0;i<result.length;i++){
					ue.setContent('<img src="'+pichost+result[i]+'"/>',true);
				}
			},10); return true; }, queryCommandState: function() { } };
