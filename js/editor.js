	...
	var methods = {
		...
		imageWidget: function(){
			...
			handleFileSelect = function(evt) {
				...
				for (var i = 0, f; f = files[i]; i++) {
					...
					reader.onload = (function(imageFile){
						return function(e){
							//Render Thumnails
							var li = $('<li/>',{class:" col-sm-6 col-md-3 col-lg-3"});
							var a = $('<a/>',{
			...
			var getURL = $("<button/>",{
				...
				var li = $('<li/>',{class:"span6  col-sm-6 col-md-3 col-lg-3"});
				var a = $('<a/>',{
					href:"javascript:void(0)",
					class:"thumbnail"
				});
			...
			var imageListContainer = $("<div/>",{'class': ' col-sm-12 col-md-12 col-lg-12'});
